...
const IMAGES = [
  "/LandingPage/LandingPageImg-1.jpg",
  "/LandingPage/LandingPageImg-2.jpg",
  "/LandingPage/LandingPageImg-3.jpg",
  "/LandingPage/LandingPageImg-4.jpg",
  "/LandingPage/LandingPageImg-5.jpg",
  "/LandingPage/LandingPageImg-6.jpg",
  "/LandingPage/LandingPageImg-7.jpg",
];

export default function NFTCarousel() {
  return (
    <section className="relative w-full overflow-hidden py-10 rotate-[-2deg] scale-105">
      ...
      {/* Marquee Container */}
      <div className="flex w-[200%] animate-[marquee_40s_linear_infinite] hover:[animation-play-state:paused] gap-6 px-4">
        {[...IMAGES, ...IMAGES, ...IMAGES].map((src, index) => (
          <div
            key={`${src}-${index}`}
            className="relative w-[300px] h-[400px] md:w-[350px] md:h-[450px] shrink-0 glass-card backdrop-blur-xl bg-white/5 overflow-hidden group cursor-pointer border border-white/10 hover:border-fuchsia-500/50 hover:shadow-[0_0_30px_rgba(217,70,239,0.3)] transition-all duration-500"
          >
