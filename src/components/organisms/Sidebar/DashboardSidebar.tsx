...
export function DashboardSidebar({
    ...
    return (
        <Sidebar
            collapsible="icon"
            className="border-white/5 border-r bg-black/40 backdrop-blur-3xl"
            {...props}
        >
            <SidebarHeader className="border-white/5 border-b py-3">
            ...
            <SidebarFooter className="border-white/5 border-t py-3">
