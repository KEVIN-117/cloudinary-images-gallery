...
export function Navigation() {
    ...
    return (
        <Disclosure as="nav" className="bg-gray-800 md:flex flex-none">
            {({ open }) => (
                <>
                                    ...
                                    <div className="flex space-x-4">
                                        {navigation.map((item) => (
                                            <Link
                                                key={item.name}
                                                href={item.href}
                                                className={`${pathname === item.href ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}
